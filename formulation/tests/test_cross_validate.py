...
class test_cross_validate(unittest.TestCase):

    def test_cross_validate_grid_search(self):
    ...
    def test_cross_validate_n_predictors(self):
        ...
        best_p = cross_validate_n_predictors(X_df, y_df, max_depth,
                                             n_estimators)
